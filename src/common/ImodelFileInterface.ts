...
export abstract class ImodelFileInterface extends RpcInterface {
  ...
  public async addSphere(_iModelToken: IModelToken, _basicDefinitions: IModelBasicDefinitions, _x: number, _y: number, _z: number, _radius: number): Promise<string> { return this.forward(arguments); }
